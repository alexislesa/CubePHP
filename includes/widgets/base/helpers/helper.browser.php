 ...
 *
 * <li>21.01.2012 <br/>
 *	- Creación de Helpers Browser.</li>
 * </ul>
 *
 * @package		CubePHP
 * @subpackage	helpers 
 ...
 * @subpackage	helpers
 * @category	browser
 * @return		string	Nombre del navegador detectado
 */
function browser() {
	$browsers = array(
		'Opera' 				=> '(Opera)',
...
/**
 * Retorna si es un dispositivo móvil
 *
 * @package		CubePHP
 * @subpackage	helpers
 * @category	browser 
 * @param		string	$iphone		Url a direccionar si es dispositivo: iphone
 * @param		string	$ipad		Url a direccionar si es dispositivo: ipad
 * @param		string	$android	Url a direccionar si es SisOp: android
 * @param		string	$opera		Url a direccionar si es navegador: opera
 * @param		string	$blackberry	Url a direccionar si es dispositivo: blackberry
 * @param		string	$palm		Url a direccionar si es dispositivo: palm
 * @param		string	$windows	Url a direccionar si es SisOp: windows
 * @param		string	$redirect	Url a direccionar por defecto
 * @param		string	$desktop	Url a direccionar si es Pc de escritorio
 * @return		array	Array con información del dispositivo, false en caso de que no sea móvil
 */
function isMobile($iphone = TRUE, $ipad = TRUE, $android = TRUE , $opera = TRUE, $blackberry = TRUE, $palm = TRUE, $windows = TRUE, $redirect = FALSE, $desktop = FALSE) {
	$mobile    = FALSE; 
  	$userAgent = $_SERVER['HTTP_USER_AGENT'];
	
	// Modificado por Alexis Lesa para evitar error al intentar acceder desde un dipositivo que no soporte
	...
	$array = array(
  	...
  	if($redirect = ($mobile === TRUE) ? $redirect : $desktop) {
